...
**Status:** A latent dynamics model now ships in `components/latent_world_model.py`, but it does not yet provide Dreamer-style recurrent imagination or value heads. Track the remaining work in `docs/issues/001-dreamer-world-model-upgrade.md`.
